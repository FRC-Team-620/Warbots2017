...
public class RobotMap {
    ...
    /**1*/
    public static DigitalInput ballDownLimit;
    /**5*/
    public static DigitalInput ballUpLimit;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public static void init() {
    	climberContactLimit= new DigitalInput(4);
    	climberDownLimit = new DigitalInput(2);
    	climberUpLimit = new DigitalInput(3);
//    	ballDownLimit = new DigitalInput(1);
//    	ballUpLimit = new DigitalInput(5);
