...
/**
 * Created by cameronearle on 2/16/17.
 */

public class LIDARIO implements PIDSource  {
    ...
    public LIDARIO(I2C.Port port, Hardware hardware) {
    ...
    @Override
   	...
   	public double pidGet() {
   		if (pid_source_type == PIDSourceType.kRate) {
   			...
   			return getLatestData().getDistance(Unit.INCHES);
   		}
   	}
}